    ...
    <div class="sidebar">
      <div class="additional-params">
        ...
        >
          ...
          <a-form-item>
            <a-button type="primary" html-type="submit" :loading="state.loading">区块文本</a-button>
          </a-form-item>
        </a-form>
        ...
        <div class="upload" v-if="state.useFile">
          ...
          >
            ...
            <p class="ant-upload-hint">
              ...
              目前仅支持上传文本文件，如  .txt, .md。且同名文件无法重复添加
            </p>
          </a-upload-dragger>
        </div>
        <textarea v-if="!state.useFile" v-model="text" placeholder="输入要区块的文本"></textarea>
