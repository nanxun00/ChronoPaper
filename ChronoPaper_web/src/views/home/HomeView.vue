<template>
  <div class="welcome">
    <header class="glass-header">ChronoPaper</header>
    <h1>{{ title }}</h1>
    <p>论文智能化管理与时序溯源系统</p>
    <button class="home-btn" @click="goToChat">开始对话</button>
    <img src="/logo.png" alt="ChronoPaper" class="home-logo" />
    <footer>© ChronoPaper 2025 [WIP] v0.0.1</footer>
  </div>
</template>
