...
def parse_latex_table(text):
    ...
    models = []
    data = []  # 每个元素: [p_mean, p_std, p_mae, s_mean, s_std, s_mae]
    for line in lines:
...
metrics = ['P-Res Mean', 'P-Res Std', 'P-Res MAE', 'S-Res Mean', 'S-Res Std', 'S-Res MAE']
...
for idx, ax in enumerate(axes_flat):
    ...
    ax.set_ylabel(metrics[idx], fontsize=11)
    ax.set_title(metrics[idx], fontsize=13, fontweight='bold')
...
# ---------- 单独放缩显示差异更大的 MAE 和 Mean ----------
fig2, axes2 = plt.subplots(1, 2, figsize=(14, 5))

# P-Res MAE
ax = axes2[0]
vals = arr[:, 2]  # P-Res MAE
