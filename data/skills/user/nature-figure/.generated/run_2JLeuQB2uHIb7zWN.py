...
bars1 = ax.bar(x - width, test_p_f1_scores, width, label='test_p_f1')
bars2 = ax.bar(x, test_s_f1_scores, width, label='test_s_f1')
bars3 = ax.bar(x + width, test_time_acc_scores, width, label='test_time_acc')
