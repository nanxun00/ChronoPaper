...
class Retriever:
    ...
    def reco_entities(self, query, history, refs):
        ...
        if refs["meta"].get("use_graph"):
            from src.integrations.llm.prompts import entity_extraction_prompt_template as entity_template
            from src.integrations.llm.prompts import keywords_prompt_template as entity_template
